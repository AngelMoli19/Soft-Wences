...
root = tk.Tk()
root.title("Propiedades del aire seco a presión atmosférica")
...
label=tk.Label(root, text="Ingrese temperatura del aire °C:")
...
# Valor b
etiqueta1 = tk.Label(root, text="Coeficiente de expansión volumétrica K-1", bg="yellow", font=("Arial", 10))
etiqueta1.place(x=50, y=110)  # Coordenadas absolutas

# Valor r
etiqueta2 = tk.Label(root, text="Densidad kg/m3", bg="yellow", font=("Arial", 10))
etiqueta2.place(x=50, y=140)  # Coordenadas absolutas

# Valor Cp
etiqueta3 = tk.Label(root, text="Calor específico kJ/kg K", bg="yellow", font=("Arial", 10))
etiqueta3.place(x=50, y=170)  # Coordenadas absolutas

# Valor k
etiqueta4 = tk.Label(root, text="Conductividad termal W/m K", bg="yellow", font=("Arial", 10))
etiqueta4.place(x=50, y=200)  # Coordenadas absolutas

# Valor alfa
etiqueta5 = tk.Label(root, text="Difusividad térmica x 10-6 m2/s", bg="yellow", font=("Arial", 10))
etiqueta5.place(x=50, y=230)  # Coordenadas absolutas

# Valor mu
etiqueta6 = tk.Label(root, text="Viscosidad absoluta x 10-6 Pa s", bg="yellow", font=("Arial", 10))
etiqueta6.place(x=50, y=260)  # Coordenadas absolutas

# Valor mu cinemática
etiqueta7 = tk.Label(root, text="Viscosidad cinemática x 10-6 m2/s", bg="yellow", font=("Arial", 10))
etiqueta7.place(x=50, y=290)  # Coordenadas absolutas

# Valor Pr
etiqueta8 = tk.Label(root, text="Número de Prandtl", bg="yellow", font=("Arial", 10))
