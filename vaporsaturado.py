...
archivo = "Sat-steam.csv"

df = pd.read_csv(archivo)

#df=pd.read_excel(archivo)

# Extraer propiedades del vapor saturado (cada columna)
x = df['x'].values
y1 = df['y1'].values
y2 = df['y2'].values
y3 = df['y3'].values
...
root = tk.Tk()
root.title("Propiedades del vapor saturado")
...
label=tk.Label(root, text="Ingrese temperatura del vapor °C:")
...
etiqueta1 = tk.Label(root, text="Presión de saturación del vapor KPa", bg="yellow", font=("Arial", 10))
etiqueta1.place(x=50, y=110)  # Coordenadas absolutas

# Valor b
etiqueta2 = tk.Label(root, text="Densidad líquido kg/m3", bg="yellow", font=("Arial", 10))
etiqueta2.place(x=50, y=140)  # Coordenadas absolutas

# Valor r
etiqueta3 = tk.Label(root, text="Densidad vapor kg/m3", bg="yellow", font=("Arial", 10))
etiqueta3.place(x=50, y=170)  # Coordenadas absolutas

# Valor Cp
etiqueta4 = tk.Label(root, text="Entalpía líquido kJ/kg", bg="yellow", font=("Arial", 10))
etiqueta4.place(x=50, y=200)  # Coordenadas absolutas

# Valor k
etiqueta5 = tk.Label(root, text="Entalpía vapor kJ/kg", bg="yellow", font=("Arial", 10))
etiqueta5.place(x=50, y=230)  # Coordenadas absolutas

# Valor alfa
etiqueta6 = tk.Label(root, text="Entropía líquido kJ/kg K", bg="yellow", font=("Arial", 10))
etiqueta6.place(x=50, y=260)  # Coordenadas absolutas

# Valor mu
etiqueta7 = tk.Label(root, text="Entropía vapor kJ/kg K", bg="yellow", font=("Arial", 10))
